# Treasury Management — Circle Wallets Adapter

Multi-chain treasury management built on App Kit's unified balance, using a Circle-managed wallet (testnet flow).

- Receive USDC on a single Circle wallet across Ethereum Sepolia, Base Sepolia, and Arc Testnet
...
npm install
cp .env.example .env
# fill in CIRCLE_API_KEY, CIRCLE_ENTITY_SECRET, TREASURY_WALLET_ID,
# TREASURY_ADDRESS, and KIT_KEY
```
